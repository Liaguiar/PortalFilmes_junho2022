const API_KEY = 'dbfc708645046e7aa25b91f53b5bccfc';
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 lancamento-poster">
							<a target="_blank" class="text-info" href="/detalheFilme.html?id=${filme.id}">
  ...
  for (i = 0; i < 4; i++) {
    ...
    texto += `
			<div class="filme-destaque col-12 col-md-6 col-lg-3 thumbnail ">
				<a target="_blank" href="/detalheFilme.html?id=${filme.id}">
